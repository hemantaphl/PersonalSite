            ...
            <div className="max-w-screen-xl mx-auto px-4">
              <div className="flex items-center gap-x-4">
                <div className="shrink-0">
                  <img className="w-16 h-16 rounded-full object-cover ring-2 ring-purple-500 shadow-md" src={ProfileImage} alt="Avatar" />
                </div>
                <div>
              ...
              <div className="pt-5">
                <a href={Resume} className="bg-purple-700 text-white px-4 py-2 rounded-md text-sm font-medium transition duration-300 ease-in-out transform hover:scale-105 hover:bg-gray-700 inline-block">Download Resume</a>
              </div>
            ...
            <div className="max-w-4xl mx-auto px-6">
              ...
              <div className="space-y-10">
                <div className="group relative flex items-start gap-x-6">
                  <div className="flex-1 bg-gradient-to-r from-gray-200 to-gray-100 border border-purple-400 p-6 rounded-lg shadow-sm border border-gray-700 transform transition duration-300 ease-in-out hover:scale-105">
          ...
          <section className="py-7">
            <div className="max-w-4xl mx-auto px-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="border border-purple-400 bg-gradient-to-r from-gray-200 to-gray-100  p-6 rounded-lg shadow-sm space-y-4 border border-gray-700 transform transition duration-300 ease-in-out hover:scale-105">
          ...
          <section className="py-7 bg-gradient-to-r from-gray-200 to-gray-100  text-gray-800 px-6">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-2 gap-4 text-base text-black max-w-4xl mx-auto">
              {[
                ...
                <div key={skill} className="border border-purple-400 bg-gradient-to-r from-gray-200 to-gray-100  rounded-md px-3 py-3 shadow-sm border border-gray-700 transform transition duration-300 ease-in-out hover:scale-105">{skill}</div>
              ))}
            </div>
          </section>
        </main>
