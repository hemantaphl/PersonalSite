        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="border border-purple-400 bg-gradient-to-r from-gray-200 to-gray-100 text-black rounded-xl p-6 shadow-lg">
            ...
            <button
                type="submit"
                disabled={!domain}
                className="cursor-pointer mt-4 bg-purple-700 text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-gray-900 transition duration-300 ease-in-out transform hover:scale-105"
            >
                Lookup DNS
            </button>
            </form>
